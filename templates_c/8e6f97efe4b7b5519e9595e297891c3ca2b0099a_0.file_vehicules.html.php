<?php
/* Smarty version 5.4.3, created on 2025-03-27 18:10:06
  from 'file:views/sections/vehicules.html' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_67e5947ed2bcd7_95844190',
...
function content_67e5947ed2bcd7_95844190 (\Smarty\Template $_smarty_tpl) {
...
">
                                    <span class="filters-checkmark"></span>
                                    <div class="filters-brand-info">
                                            <span class="filters-brand-name"><?php echo $_smarty_tpl->getValue('carburant')->getNom_carburant();?>
</span>
                                    </div>
                                </label>
                            </div>
...
">
                                    <span class="filters-checkmark"></span>
                                    <div class="filters-brand-info">
                                            <span class="filters-brand-name"><?php echo $_smarty_tpl->getValue('option')->getNom_option();?>
</span>
                                    </div>
                                </label>
                            </div>
...
?>
                                            <div class="option-checkbox">
                                                <input type="checkbox" 
                                                       ...
                                                       value="<?php echo $_smarty_tpl->getValue('option')->getId_option();?>
"
                                                       id="option-vehicule-<?php echo $_smarty_tpl->getValue('option')->getId_option();?>
">
                                                <label for="option-vehicule-<?php echo $_smarty_tpl->getValue('option')->getId_option();?>
">
